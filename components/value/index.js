    ...
    return(
        <div className={styles.wrapperView}>
            <div className={styles.contentView}>
                <span className={styles.title}>{`kick back brings back non-verbal cues in 3D spaces; all with just your laptop`}</span>
                <div className={styles.groupEyeView}>
                    <div className={styles.noEyeContact}>
                        <span className={styles.titleGroup}>{`No eye contact`}</span>
                        <Image src={noEyeContact} alt={"noEyeContactBanner"}/>
                    </div>
                    <div className={styles.eyeContact}>
                        <span className={styles.titleGroup}>{`Eye contact enabled`}</span>
