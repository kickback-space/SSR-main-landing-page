...
import { communityCopy } from '../utils/copyright_variables';

export default function communityPage() {
  return (
    <div>
      <Head>
        <title>kick back space</title>
        <meta
          name='description'
      ...
      <main>
        <Header />
        <Panel copy={communityCopy}/>
        {/* <Information /> */}
        <TraditionView copy={communityCopy}/>
        <SolutionView copy={communityCopy}/>
        {/* <VirtualOffice /> */}
        {/* <Easy /> */}
        {/* <Value /> */}
